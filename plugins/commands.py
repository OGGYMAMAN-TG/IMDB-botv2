...
async def bot_info(bot, message):
    ...
    await message.reply(text=f"<b>Developer : <a href='https://t.me/OGGYMAMAN'>OGGYMAMAN</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='{TUTORIAL}'>Click here</a>\nUpdate Channel : <a href='https://t.me/ULTRONBOTSV'>OGGY MAMAN</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
